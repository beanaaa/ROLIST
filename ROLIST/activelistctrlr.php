...
<form></form>
<form name = "form110" id = "form110" method = "post" action ="activelistctrlr.php">
...
<form name = "form111" id = "form112" method = "post" action ="activelistctrlr.php">
...
<form name = "form112" id = "form112" method = "post" action ="activelistctrlr.php">
...
<form></form>
<form name = "formSite" id = "formSite" method = "post" action ="activelistctrlr.php">
...
<form id=form11 name=form11 method=post action="activelistctrlr.php">
	<th align=right >
		<input type = "hidden" name = "weekago"	id ="weekago" value = <?php echo $week_post; ?> />
...
<form id=form11 name=form11 method=post target=_blank  action="activelistctrlr_backup.php">
...
// 치료함
    echo "<form id=form111 name=form111></form>";
    echo "<td rowspan = $spanNum bgcolor=$bgcolorF><form id=form3 name=form3 method=post action=activelistctrlr.php>";                                   
